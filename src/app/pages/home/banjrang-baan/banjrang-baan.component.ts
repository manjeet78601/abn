...
@Component({
  selector: 'app-banjrang-baan',
  templateUrl: './banjrang-baan.component.html',
  styleUrls: ['./banjrang-baan.component.scss'],
})
export class BanjrangBaanComponent implements OnInit {
