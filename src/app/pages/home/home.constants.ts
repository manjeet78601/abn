export class HomeConstants {
   ...
   public static HOME_PAGE = {
      ...
      PLAN_STEP_TWO: {
         TITLE: '॥ श्री बजरंग बाण का पाठ ॥',
         CONTENT: `<p class="col-blk">Hanumaan</br> Chalisa</p>`,
      },
      PLAN_STEP_TWO_100: {
      ...
      PLAN_STEP_TWO_001: {
         TITLE: '॥ श्री सुन्दर काण्ड का पाठ ॥',
         CONTENT: `<p class="col-blk">Hanumaan</br> Chalisa</p>`,
      },
      PLAN_STEP_TWO_002:{
         TITLE: '॥ श्री हनुमानाष्टक ॥',
         CONTENT: `<p class="col-blk">Hanumaan</br> Chalisa</p>`,
      },
      PLAN_STEP_TWO_003: {
      ...
      PLAN_STEP_TWO_005: {
         TITLE: '॥ श्री रामायण जी की आरती॥',
         CONTENT: `<p class="col-blk">Hanumaan</br> Chalisa</p>`,
      },
      PLAN_STEP_TWO_006: {
         TITLE: '॥ श्री हनुमान  शक्ति पीठ ॥',
         CONTENT: `<p class="col-blk">Hanumaan</br> Chalisa</p>`,
      },
      PLAN_STEP_TWO_007: {
      ...
      PLAN_STEP_TWO_008: {
         TITLE: '॥ हर मंगलवार पढ़ें  श्री रामभक्त श्री हनुमान के 108 चमत्कारी नाम ॥',
         CONTENT: `<p class="col-blk">Hanumaan</br> Chalisa</p>`,
      },
      PLAN_STEP_THREE: {
         TITLE: 'STEP THREE',
   ...
   public static BUDGET_CALCULATOR = {
      PAGE_HEADER: '॥ श्री सुन्दर काण्ड का पाठ ॥',
      PAGE_SUB_TEXT: `
...
सहज भीरु कर बचन दृढ़ाई।
सागर सन ठानी मचलाई।।

मूढ़ मृषा का करसि बड़ाई।
रिपु बल बुद्धि थाह मैं पाई।।

सचिव सभीत बिभीषन जाकें।
बिजय बिभूति कहाँ जग ताकें।।

सुनि खल बचन दूत रिस बाढ़ी।
समय बिचारि पत्रिका काढ़ी।।

रामानुज दीन्ही यह पाती।
नाथ बचाइ जुड़ावहु छाती।।
...
सकल ताड़ना के अधिकारी।।

प्रभु प्रताप मैं जाब सुखाई।
उतरिहि कटकु न मोरि बड़ाई।।
...
पञ्चमः सोपानः समाप्तः ।`,
   ...
   public static LIFE_INSURANCE_SUB_HEADER = `चौपाई :
